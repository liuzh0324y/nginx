#define NGX_CONFIGURE " --with-cc-opt='-D FD_SETSIZE=4096' --add-module=../nginx-rtmp-module"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "vc11"
#endif


#ifndef NGX_HAVE_GCC_ATOMIC
#define NGX_HAVE_GCC_ATOMIC  0
#endif
